...
//    @Autowired
    ...
    public Object list(String keyword, String url,
        ...
        List<EtmallKeyword> keywordList = keywordService.querySelective(keyword, url, page, limit, sort, order);
        return ResponseUtil.okList(keywordList);
    }

    private Object validate(EtmallKeyword keywords) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody EtmallKeyword keyword) {
    ...
    public Object read(@NotNull Integer id) {
        EtmallKeyword keyword = keywordService.findById(id);
        return ResponseUtil.ok(keyword);
    }
    ...
    @PostMapping("/update")
    public Object update(@RequestBody EtmallKeyword keyword) {
        Object error = validate(keyword);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody EtmallKeyword keyword) {
