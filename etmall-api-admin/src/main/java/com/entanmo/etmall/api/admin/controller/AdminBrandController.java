...
public class AdminBrandController {
    ...
    public Object list(String id, String name,
        ...
        List<EtmallBrand> brandList = brandService.querySelective(id, name, page, limit, sort, order);
        return ResponseUtil.okList(brandList);
    }

    private Object validate(EtmallBrand brand) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody EtmallBrand brand) {
    ...
    public Object read(@NotNull Integer id) {
        EtmallBrand brand = brandService.findById(id);
        return ResponseUtil.ok(brand);
    }
    ...
    @PostMapping("/update")
    public Object update(@RequestBody EtmallBrand brand) {
        Object error = validate(brand);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody EtmallBrand brand) {
