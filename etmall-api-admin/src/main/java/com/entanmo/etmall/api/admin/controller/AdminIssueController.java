...
public class AdminIssueController {
    ...
    private Object validate(EtmallIssue issue) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody EtmallIssue issue) {
    ...
    public Object read(@NotNull Integer id) {
        EtmallIssue issue = issueService.findById(id);
        return ResponseUtil.ok(issue);
    }
    ...
    @PostMapping("/update")
    public Object update(@RequestBody EtmallIssue issue) {
        Object error = validate(issue);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody EtmallIssue issue) {
