...
import com.entanmo.etmall.db.service.EtmallFeedbackService;
...
public class AdminFeedbackController {
    ...
    public Object list(Integer userId, String username,
        ...
        List<EtmallFeedback> feedbackList = feedbackService.querySelective(userId, username, page, limit, sort,
                order);
