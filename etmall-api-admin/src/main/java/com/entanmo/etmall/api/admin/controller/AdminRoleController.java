...
import com.entanmo.etmall.core.util.AdminResponseCode;
...
import com.entanmo.etmall.core.vo.PermVo;
...
import static com.entanmo.etmall.core.util.AdminResponseCode.ROLE_NAME_EXIST;
import static com.entanmo.etmall.core.util.AdminResponseCode.ROLE_USER_EXIST;
...
//    @Autowired
    ...
    public Object list(String name,
        ...
        List<EtmallRole> roleList = roleService.querySelective(name, page, limit, sort, order);
        return ResponseUtil.okList(roleList);
    }

    @GetMapping("/options")
    public Object options() {
        List<EtmallRole> roleList = roleService.queryAll();
    ...
    public Object read(@NotNull Integer id) {
        EtmallRole role = roleService.findById(id);
        return ResponseUtil.ok(role);
    }


    private Object validate(EtmallRole role) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody EtmallRole role) {
    ...
    @PostMapping("/update")
    public Object update(@RequestBody EtmallRole role) {
        Object error = validate(role);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody EtmallRole role) {
        ...
        List<EtmallAdmin> adminList = adminService.all();
        for (EtmallAdmin admin : adminList) {
    ...
    public Object updatePermissions(@RequestBody String body) {
        ...
        for (String permission : permissions) {
            EtmallPermission EtmallPermission = new EtmallPermission();
            EtmallPermission.setRoleId(roleId);
            EtmallPermission.setPermission(permission);
            permissionService.add(EtmallPermission);
        }
        return ResponseUtil.ok();
    }
