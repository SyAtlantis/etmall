...
import com.entanmo.etmall.core.config.ExpressProperties;
import com.entanmo.etmall.core.util.HttpUtil;
...
public class ExpressService {
     ...
     * 获取物流信息
     */
    public ExpressInfoVo getExpressInfo(String expCode, String expNo) {
        try {
            String result = getOrderTracesByJson(expCode, expNo);
            ObjectMapper objMap = new ObjectMapper();
            ExpressInfoVo ei = objMap.readValue(result, ExpressInfoVo.class);
