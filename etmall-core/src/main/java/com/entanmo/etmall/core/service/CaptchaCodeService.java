...
import com.entanmo.etmall.core.vo.CaptchaVo;
...
public class CaptchaCodeService {
    ...
    private static ConcurrentHashMap<String, CaptchaVo> captchaCodeCache = new ConcurrentHashMap<>();
    ...
    public static boolean addToCache(String phoneNumber, String code) {
        ...
        CaptchaVo captchaItem = new CaptchaVo();
