...
--
-- Host: 127.0.0.1    Database: etmall
-- ------------------------------------------------------
...
--
-- Table structure for table `etmall_ad`
--

DROP TABLE IF EXISTS `etmall_ad`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `etmall_ad` (
...
--
-- Table structure for table `etmall_address`
--

DROP TABLE IF EXISTS `etmall_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `etmall_address` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `etmall_admin`
--

DROP TABLE IF EXISTS `etmall_admin`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `etmall_admin` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `etmall_brand`
--

DROP TABLE IF EXISTS `etmall_brand`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `etmall_brand` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `etmall_cart`
--

DROP TABLE IF EXISTS `etmall_cart`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `etmall_cart` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `etmall_category`
--

DROP TABLE IF EXISTS `etmall_category`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `etmall_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `etmall_collect`
--

DROP TABLE IF EXISTS `etmall_collect`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `etmall_collect` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL DEFAULT '0' COMMENT '用户表的用户ID',
...
--
-- Table structure for table `etmall_comment`
--

DROP TABLE IF EXISTS `etmall_comment`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `etmall_comment` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `etmall_coupon`
--

DROP TABLE IF EXISTS `etmall_coupon`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `etmall_coupon` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `etmall_coupon_user`
--

DROP TABLE IF EXISTS `etmall_coupon_user`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `etmall_coupon_user` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `etmall_feedback`
--

DROP TABLE IF EXISTS `etmall_feedback`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `etmall_feedback` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL DEFAULT '0' COMMENT '用户表的用户ID',
...
--
-- Table structure for table `etmall_footprint`
--

DROP TABLE IF EXISTS `etmall_footprint`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `etmall_footprint` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL DEFAULT '0' COMMENT '用户表的用户ID',
...
--
-- Table structure for table `etmall_goods`
--

DROP TABLE IF EXISTS `etmall_goods`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `etmall_goods` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `etmall_goods_attribute`
--

DROP TABLE IF EXISTS `etmall_goods_attribute`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `etmall_goods_attribute` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `etmall_goods_product`
--

DROP TABLE IF EXISTS `etmall_goods_product`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `etmall_goods_product` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `goods_id` int(11) NOT NULL DEFAULT '0' COMMENT '商品表的商品ID',
...
--
-- Table structure for table `etmall_goods_specification`
--

DROP TABLE IF EXISTS `etmall_goods_specification`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `etmall_goods_specification` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `goods_id` int(11) NOT NULL DEFAULT '0' COMMENT '商品表的商品ID',
...
--
-- Table structure for table `etmall_groupon`
--

DROP TABLE IF EXISTS `etmall_groupon`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `etmall_groupon` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `order_id` int(11) NOT NULL COMMENT '关联的订单ID',
  `groupon_id` int(11) DEFAULT '0' COMMENT '参与的团购ID，仅当user_type不是1',
  `rules_id` int(11) NOT NULL COMMENT '团购规则ID，关联etmall_groupon_rules表ID字段',
  `user_id` int(11) NOT NULL COMMENT '用户ID',
...
--
-- Table structure for table `etmall_groupon_rules`
--

DROP TABLE IF EXISTS `etmall_groupon_rules`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `etmall_groupon_rules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `etmall_issue`
--

DROP TABLE IF EXISTS `etmall_issue`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `etmall_issue` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `etmall_keyword`
--

DROP TABLE IF EXISTS `etmall_keyword`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `etmall_keyword` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `etmall_log`
--

DROP TABLE IF EXISTS `etmall_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `etmall_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `etmall_order`
--

DROP TABLE IF EXISTS `etmall_order`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `etmall_order` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `etmall_order_goods`
--

DROP TABLE IF EXISTS `etmall_order_goods`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `etmall_order_goods` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `etmall_permission`
--

DROP TABLE IF EXISTS `etmall_permission`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `etmall_permission` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `etmall_region`
--

DROP TABLE IF EXISTS `etmall_region`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `etmall_region` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `etmall_role`
--

DROP TABLE IF EXISTS `etmall_role`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `etmall_role` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `etmall_search_history`
--

DROP TABLE IF EXISTS `etmall_search_history`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `etmall_search_history` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL COMMENT '用户表的用户ID',
...
--
-- Table structure for table `etmall_storage`
--

DROP TABLE IF EXISTS `etmall_storage`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `etmall_storage` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `etmall_system`
--

DROP TABLE IF EXISTS `etmall_system`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `etmall_system` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `etmall_topic`
--

DROP TABLE IF EXISTS `etmall_topic`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `etmall_topic` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `etmall_user`
--

DROP TABLE IF EXISTS `etmall_user`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `etmall_user` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `login_type` tinyint(3) NOT NULL DEFAULT '0' COMMENT '0 自己账号, 1 微博, 2 微信，3 闲聊，4 sugram',
  `add_time` datetime DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  `deleted` tinyint(1) DEFAULT '0' COMMENT '逻辑删除',
  PRIMARY KEY (`id`),
...
--
-- Table structure for table `etmall_user_formid`
--

DROP TABLE IF EXISTS `etmall_user_formid`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `etmall_user_formid` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
