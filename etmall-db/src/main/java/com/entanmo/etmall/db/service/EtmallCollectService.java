...
import com.entanmo.etmall.db.dao.EtmallCollectMapper;
...
@Service
public class EtmallCollectService {

    @Resource
    private EtmallCollectMapper collectMapper;
    ...
    public List<EtmallCollect> queryByType(Integer userId, Byte type, Integer page, Integer limit, String sort, String order) {
        EtmallCollectExample example = new EtmallCollectExample();
        EtmallCollectExample.Criteria criteria = example.createCriteria();
    ...
    public EtmallCollect queryByTypeAndValue(Integer userId, Byte type, Integer valueId) {
        EtmallCollectExample example = new EtmallCollectExample();
    ...
    public int add(EtmallCollect collect) {
        collect.setAddTime(LocalDateTime.now());
        collect.setUpdateTime(LocalDateTime.now());
        return collectMapper.insertSelective(collect);
    }

    public List<EtmallCollect> querySelective(String userId, String valueId, Integer page, Integer size, String sort, String order) {
        EtmallCollectExample example = new EtmallCollectExample();
        EtmallCollectExample.Criteria criteria = example.createCriteria();
