...
//    @Resource
     ...
     * 查询，空参数
     */
    public List<EtmallCoupon> queryList(int offset, int limit, String sort, String order) {
        return queryList(EtmallCouponExample.newAndCreateCriteria(), offset, limit, sort, order);
    }

    /**
     * 查询
     */
    public List<EtmallCoupon> queryList(EtmallCouponExample.Criteria criteria, int offset, int limit, String sort, String order) {
    ...
    public EtmallCoupon findById(Integer id) {
        return couponMapper.selectByPrimaryKey(id);
    }


    public EtmallCoupon findByCode(String code) {
        ...
        List<EtmallCoupon> couponList =  couponMapper.selectByExample(example);
     ...
     * 查询新用户注册优惠券
     */
    public List<EtmallCoupon> queryRegister() {
        EtmallCouponExample example = new EtmallCouponExample();
    ...
    public List<EtmallCoupon> querySelective(String name, Short type, Short status, Integer page, Integer limit, String sort, String order) {
        EtmallCouponExample example = new EtmallCouponExample();
        EtmallCouponExample.Criteria criteria = example.createCriteria();
    ...
    public void add(EtmallCoupon coupon) {
        coupon.setAddTime(LocalDateTime.now());
        coupon.setUpdateTime(LocalDateTime.now());
        couponMapper.insertSelective(coupon);
    }

    public int updateById(EtmallCoupon coupon) {
        coupon.setUpdateTime(LocalDateTime.now());
     ...
     */
    public List<EtmallCoupon> queryExpired() {
        EtmallCouponExample example = new EtmallCouponExample();
